# BLOCKER: Mobile Customer Build/Test
...
- Path checked: source/apps/mobile-customer/
...
**Evidence Path:** local-ci/verification/micro_audit/LATEST/build_test/mobile_customer_flutter_check.log
