# REALITY MAP - Urban Points Lebanon

**Generated:** 2026-01-25T15:51:20.661932Z
**Git Commit:** f0f8875c4e
...
|------|--------|----------|-------|
| **Auth** | DONE | source/backend/firebase-functions/src/auth.ts | Firebase Auth + custom claims |
| **Users/Profiles** | PARTIAL | src/auth.ts | User CRUD exists, profile sync pending |
| **Offers** | DONE | source/backend/firebase-functions/src/core/offers.ts | Full CRUD for merchant offers |
...
| **Tests** | PARTIAL | 38 test files | Unit tests for core functions |
...
| **Tests** | PARTIAL | 3 test files | Limited coverage |
...
| **Tests** | PARTIAL | 2 test files | Component tests exist |
...
| **Tests** | PARTIAL | 1 test files | Unit tests |
...
| **Tests** | PARTIAL | 1 test files | Basic unit tests |
...
| **CI/CD Pipeline** | PARTIAL | .github/workflows/ (1 workflow) | Basic test + deploy |
