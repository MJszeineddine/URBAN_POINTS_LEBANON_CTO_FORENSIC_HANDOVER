/// Auth Sanity Check for Customer App
...
void main() async {
  print('========================================');
  print('🧪 DAY 2 AUTH SANITY CHECK - CUSTOMER APP');
  print('========================================\n');
  ...
  if (testEmail != null && testPassword != null) {
    ...
    try {
      ...
      try {
        ...
        final validRoles = ['customer', 'user'];
        ...
        if (!validRoles.contains(effectiveRole)) {
          print('❌ FAIL: Invalid role for Customer app');
          print('   Expected: customer or user');
        ...
        print('  • Role check: ✅ Valid for Customer app');
        print('  • isActive: ✅ true');
        print('========================================\n');
